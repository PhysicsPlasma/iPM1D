Module IonMCC
     ...
     Implicit none
     contains
     subroutine SelectCollisionIon(InputParticle,InputGas,InputReaction,OuputParticle)          
         Implicit none
         ...
         Select case (InputReaction%ReactionType)
                  ...
                  Case(103_4)  ! ChargeExchange
                          Call AddParticle(InputParticle%GasParticle,OuputParticle(InputReaction%Reactant))
                  Case(111_4)
                  ...
                  Case(112_4)
                          ...
                          Call AddParticle(InputParticle%PhaseSpace,OuputParticle(ParticleIndex(1)))
                  Case(-1_4)
          end select
        return
        contains
